...
<s:form action="equipe" method="post">
<s:hidden key="equipeVO.idEquipe" value=""></s:hidden>
		...
		<td colspan="2">
			<table width="100%" align="center" class="tabelaLista"  >
				<tr>
					...
					<th class="cabecalhoLista"><s:text name="equipeVO.nmEquipe"/></th>
					<th class="cabecalhoLista"><s:text name="equipeVO.nmResponsavel"/></th>
					<th class="cabecalhoLista"><s:text name="equipeVO.dtFundacao"/></th>
					<th class="cabecalhoLista"><s:text name="equipeVO.dsTelefone1"/></th>
				</tr>
				<s:if test="equipesUsuario.size > 0">
               			...
               			<s:iterator value="usuarios" status="linha">
							...
							<s:else>
               				...
               				<tr>
	               				...
	               				<td class="${linhaClass}"><s:property value="nmEquipe"/></td>
	               				<td class="${linhaClass}"><s:property value="usuarioVO.dsNome"/></td>
	               				<td class="${linhaClass}"><s:property value="dtFundacao"/></td>
	               			</tr>
               			</s:iterator>
